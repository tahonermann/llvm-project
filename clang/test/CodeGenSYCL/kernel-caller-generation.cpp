...
// CHECK-HOST-NEXT:   %coerce.dive = getelementptr inbounds nuw %class.anon, ptr %kernelFunc, i32 0, i32 0
...
// CHECK-DEVICE-NEXT:   %[[CAPTURE:.+]] = getelementptr inbounds nuw %class.anon, ptr addrspace(4) %this1, i32 0, i32 0
// CHECK-DEVICE-NEXT:   ret void
// CHECK-DEVICE-NEXT: }
