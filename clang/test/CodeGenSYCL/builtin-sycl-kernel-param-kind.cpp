...
// Test IR generated by __builtin_sycl_kernel_param_kind(). This builtin accepts
// a SYCL kernel name type and parameter index. It returns the parameter 'kind' of
// the correponding parameter in the generated offload kernel.
...
void test() {
  ...
  constexpr const int test4 = __builtin_sycl_kernel_param_kind(kernel_id_t<constexpr_kernel_name>(), 0);
}
...
// CHECK: store i32 1, ptr %test4, align 4
