...
// Test IR generated by __builtin_sycl_kernel_param_offset(). This builtin accepts
// a SYCL kernel name type and parameter index. It returns the offset of the
// corresponding parameter in the SYCL kernel object. Currently, with no support of
// SYCL special types or decomposition, this is always 0.
...
void test() {
  ...
  int test1 = __builtin_sycl_kernel_param_offset(kernel_id_t<kernel_name_1>(), 0);
  int test2 = __builtin_sycl_kernel_param_offset(kernel_id_t<kernel_name_2>(), 1);
  int test3 = __builtin_sycl_kernel_param_offset(kernel_id_t<single_purpose_kernel_name>(),2);
  constexpr const int test4 = __builtin_sycl_kernel_param_offset(kernel_id_t<constexpr_kernel_name>(), 0);
}
...
// CHECK: store i32 0, ptr %test2, align 4
// CHECK: store i32 0, ptr %test3, align 4
// CHECK: store i32 0, ptr %test4, align 4
