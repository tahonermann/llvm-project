...
// Test IR generated by __builtin_sycl_kernel_param_count(). This builtin accepts
// a SYCL kernel name type and returns the number of parameters in its corresponding
// offload kernel.
...
void test() {
  ...
  kernel_single_task<constexpr_kernel_name>(Obj, 1);
  ...
  constexpr const int test4 = __builtin_sycl_kernel_param_count(kernel_id_t<constexpr_kernel_name>()); // Returns 2 as corresponding entry point function has 2 arguments
}
...
// CHECK: store i32 2, ptr %test4, align 4
